    ...
    sections: [
      {
        ...
        items: [
          ...
          'Inglese e italiano senza librerie i18n: un albero di route statiche per lingua, dizionari in TypeScript e un piccolo script che rileva la lingua e ricorda la scelta',
        ],
      },
      {
        index: '02',
